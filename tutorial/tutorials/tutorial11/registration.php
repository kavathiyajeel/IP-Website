...
<body>
  <div class="signup-box">
    ...
    <form action="insert.php" name="form" onsubmit="return myfunction()" id="form" method="POST">
      <label>Name</label>
      <input type="text" placeholder="" name="fname" id="name-f">
      <label>Email</label>
      <input type="Email" placeholder="" name="email" id="email">
      <label>Password</label>
      <input type="password" placeholder="" name="password" id="pass">
